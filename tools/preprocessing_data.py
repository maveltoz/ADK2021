...
parser.add_argument('--train_num', default=9000, type=int, dest='train_num')
parser.add_argument('--valid_num', default=0, type=int, dest='validation_num')
...
for i, data_name in enumerate(tqdm(jsonfile)):
    ...
    annotations.append({'image_id': id, 'id': (id + 100000),
                        'category_id': cow_data['label_info']['annotations'][0]['category_id'],
